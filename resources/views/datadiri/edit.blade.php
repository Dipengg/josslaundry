...
<body class="container mt-4">
    ...
    <form method="POST" action="/datadiri/update">
        @csrf
        <input type="hidden" value="{{ $id_datadiri }}" name="id_datadiri">
        ...
        <div class="form-group">
            ...
            <div class="form-check">
                <input type="radio" class="form-check-input" name="jeniskelamin" value="Laki-laki" @if($jeniskelamin == 'Laki-laki') checked @endif required>
                <label class="form-check-label">Laki-laki</label>
            </div>
            <div class="form-check">
                <input type="radio" class="form-check-input" name="jeniskelamin" value="Perempuan" @if($jeniskelamin == 'Perempuan') checked @endif required>
